...
export function HeroSection() {
    return (
        <section className="relative min-h-screen bg-transparent overflow-hidden">
            ...
            <Image
                src="/hero.jpg.jpg" // Assuming the image is inside /public
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-6 py-20">
                <div className="max-w-3xl">
                    <p className="text-white text-lg font-medium mb-8 tracking-wide">
                        IN PARTNERSHIP WITH FARMERS & INNOVATION
                    </p>
